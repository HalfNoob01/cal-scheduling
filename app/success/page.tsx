        ...
        <div className="h-screen w-screen flex items-center justify-center">
            <Card className="max-w-[400px] w-full mx-auto">
              <CardContent className="p-6 flex flex-col w-full items-center ">
                ...
                <h1 className="text-2xl font-semibold">This event is schedule</h1> 
                <p className="text-sm text-muted-foreground text-center">We emailed you a calendar invitation with all the details and the video call link!</p>
              </CardContent>
              <CardFooter>
