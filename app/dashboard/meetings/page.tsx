...
export default async function MeetingsRoute() {
   ...
   return (
      <>
         {data.data.length < 1 ? (
            <EmptyState title="No meetings found" description="You don't have any meetings yet."
            ...
            <Card>
               <CardHeader>
                  ...
                  <CardDescription>
                     See upcoming event which where booked with you and see the event type link.
                  </CardDescription>
               </CardHeader>
               <CardContent>
                  {data.data.map((item) => (
                        ...
                        <div className="grid grid-cols-3  justify-between items-center">
                           <div className="text-muted-foreground text-sm">
                              ...
                              <div className="flex items-center mt-1">
                                 ...
                                 <a href={item.conferencing?.details.url} className="text-xs text-primary underline underline-offset-4" target="_blank">Join Meeting</a>
                              </div>
                           </div>
